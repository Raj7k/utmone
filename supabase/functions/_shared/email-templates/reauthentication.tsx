  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="utm.one" width="120" height="40" style={logo} />
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: 'hsl(222, 47%, 11%)', margin: '0 0 30px', letterSpacing: '4px' }
