        ...
        <div className="prose prose-lg max-w-none space-y-12">
          ...
          <section>
            ...
            <p className="text-white/60 leading-relaxed mt-4">
              email <a href="mailto:privacy@utm.one" className="text-primary hover:text-primary/80 font-medium">privacy@utm.one</a> for any requests.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/60 leading-relaxed">
              for privacy questions: <a href="mailto:privacy@utm.one" className="text-primary hover:text-primary/80 font-medium">privacy@utm.one</a>
            </p>
          </section>
