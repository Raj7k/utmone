        ...
        <div className="space-y-12 text-white/60">
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <p>email support: <a href="mailto:support@utm.one" className="text-primary hover:text-primary/80 transition-colors">support@utm.one</a></p>
              <p>security issues: <a href="mailto:security@utm.one" className="text-primary hover:text-primary/80 transition-colors">security@utm.one</a></p>
            </div>
          </section>
          <section className="space-y-4">
