        ...
        <main className="flex-1 bg-white">
          <div className="max-w-text-content mx-auto px-8 py-24">
            ...
            <div className="prose prose-lg max-w-none space-y-12">
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">1. Commitment to Permanence</h2>
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">2. Service Discontinuation Protocol</h2>
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">3. Automated Backup Option</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">4. Self-Hosting Rights</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">5. Domain Ownership</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">6. Notification Requirements</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">7. Legal Enforceability</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">8. Exclusions</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">9. Questions</h2>
                <p className="text-muted-foreground leading-relaxed">
                  For questions about the Link Permanence Guarantee, contact <a href="mailto:legal@utm.one" className="text-primary hover:text-primary/80 font-medium">legal@utm.one</a>
                </p>
              </section>
