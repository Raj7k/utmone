      ...
      <MainLayout showAnnouncement={false}>
        ...
        <section className="py-24 md:py-32">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white mb-4">
                {p("from URL to print in 60 seconds")}
              </h2>
            </div>
              ...
              {[
                ...
                <Card key={index} className="p-6 transition-colors group cursor-pointer hover:border-white/20">
                  <Link to={feature.link}>
                    <h3 className="text-xl font-display font-semibold text-white mb-2 group-hover:text-white/80 transition-colors">
                      {p(feature.title)}
                    </h3>
        ...
        <section className="py-24 md:py-32 bg-white/5 border-t border-white/10">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white">
              {p("ready to stop guessing if your QR codes work?")}
            </h2>
