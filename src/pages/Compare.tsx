                  ...
                  >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-muted-foreground lowercase">
                        <span className="text-foreground font-medium">utm.one adds:</span> {tool.differentiator}
                      </p>
                    </div>
                  </Link>
                </motion.div>
        ...
        <section className="py-24 bg-muted/20">
          <div className="max-w-text-content mx-auto px-8 text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground lowercase mb-8 max-w-2xl mx-auto">
