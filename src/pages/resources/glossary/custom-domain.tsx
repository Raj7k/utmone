...
const CustomDomainTerm = () => {
  return (
    <GlossaryTermLayout
      ...
      fullDefinition={[
        "Custom Domain allows short links to use your company's domain (apple.com/go/wwdc) instead of generic shortener domain (bit.ly/abc123). Branded links increase trust, improve click-through rates by 30-40%, and reinforce brand recognition. Enterprise teams like Apple, Nike, and Tesla require custom domains for professional campaigns.",
