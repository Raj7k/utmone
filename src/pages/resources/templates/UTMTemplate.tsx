        ...
        <div className="max-w-[980px] mx-auto px-8">
          ...
          <div className="grid gap-6">
            {[
              ...
              <div key={item.field} className="p-4 rounded-lg bg-card border border-border/50">
                <code className="text-sm font-mono" style={{ color: 'rgba(59,130,246,1)' }}>{item.field}</code>
          ...
          <div className="mt-8">
            <p className="text-muted-foreground">
              ...
              <Link to="/resources/guides/utm-guide" className="hover:underline" style={{ color: 'rgba(59,130,246,1)' }}>
                UTM Guide
              </Link>
            </p>
          </div>
