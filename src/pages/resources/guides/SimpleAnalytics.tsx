        ...
        <div className="space-y-8">
          ...
          <div className="p-8 bg-card rounded-2xl border border-border/50">
            <div className="space-y-3">
              <div className="text-sm font-medium text-primary uppercase tracking-wide">metric 1</div>
          ...
          <div className="p-8 bg-card rounded-2xl border border-border/50">
            <div className="space-y-3">
              <div className="text-sm font-medium text-primary uppercase tracking-wide">metric 2</div>
          ...
          <div className="p-8 bg-card rounded-2xl border border-border/50">
            <div className="space-y-3">
              <div className="text-sm font-medium text-primary uppercase tracking-wide">metric 3</div>
