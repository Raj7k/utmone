        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="text-sm font-semibold mb-1 text-primary">T-7 Days</div>
            ...
            <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="text-sm font-semibold mb-1 text-primary">T-3 Days</div>
            ...
            <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="text-sm font-semibold mb-1 text-primary">T-1 Day</div>
            ...
            <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="text-sm font-semibold mb-1 text-primary">Launch Day</div>
            ...
            <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="text-sm font-semibold mb-1 text-primary">T+72 Hours</div>
