      ...
      <section className="py-20 bg-background border-b border-border/50">
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <Badge className="text-white animate-pulse bg-primary">NEW</Badge>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-[900px] mx-auto px-8 text-center space-y-8">
          ...
          <p className="text-lg text-foreground max-w-[720px] mx-auto">
            Once your AI-generated content is created, make sure it's discoverable by AI search engines. See our <Link to="/resources/playbooks/llm-ranking" className="text-primary font-semibold hover:underline">LLM Ranking Playbook</Link> for a complete 90-day implementation guide to rank in ChatGPT, Claude, and Perplexity.
          </p>
