    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-32 md:py-40 bg-gradient-to-br from-wildSand via-background to-background overflow-hidden">
        ...
        <div className="container max-w-[980px] mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-display font-extrabold tracking-tighter bg-gradient-to-b from-foreground to-foreground/50 bg-clip-text text-transparent">
              How utm.one works
            </h1>
