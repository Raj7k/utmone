...
const FieldMarketing = () => {
  ...
  return (
    <>
      <SEO
        title="Field Marketing Solutions - Event ROI Attribution | utm.one"
        description="Stop counting business cards. Start measuring real event impact with geo-temporal lift analysis and badge scan attribution."
        canonical="https://utm.one/solutions/field-marketing"
        keywords={["field marketing", "event ROI", "trade show attribution", "badge scan", "event marketing"]}
      />
      <WebPageSchema
        name="Field Marketing Solutions"
        description="Measure the invisible 90% of event traffic with Event Halo geo-temporal analysis."
        url="https://utm.one/solutions/field-marketing"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://utm.one" },
        { name: "Solutions", url: "https://utm.one/solutions" },
        { name: "Field Marketing", url: "https://utm.one/solutions/field-marketing" }
      ]} />
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-xl text-obsidian-text-muted">
                    ...
                    <span className="text-white font-medium"> now you'll finally know.</span>
                  </p>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10">
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div>
                          ...
                          <p className="text-xs text-obsidian-text-muted">direct scans</p>
                        </div>
                        <div>
                          <p className="text-2xl font-bold text-white">2,341</p>
                          <p className="text-xs text-obsidian-text-muted">halo visitors</p>
                        </div>
                        <div>
                          <p className="text-2xl font-bold text-primary">$3.7M</p>
                          <p className="text-xs text-obsidian-text-muted">pipeline</p>
                        </div>
                      </div>
                    </div>
                  </div>
