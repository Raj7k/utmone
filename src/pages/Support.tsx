        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <div className="border border-white/10 rounded-2xl p-8 bg-white/5 backdrop-blur-xl">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 hover:underline font-medium text-white/80"
            >
              support@utm.one
        ...
        <div className="mt-16 border-t border-white/10 pt-16">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 text-center">
            ...
            <a
              ...
              className="inline-block px-8 py-3 rounded-xl font-medium transition-colors hover:opacity-90 bg-white text-zinc-950"
            >
