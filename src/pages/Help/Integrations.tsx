...
const articles = [
  ...
  { title: "GA4 integration", description: "Send utm.one click data to Google Analytics 4 for unified reporting in your existing dashboards.", href: "/help/articles/ga4-integration", icon: BarChart3, tier: "growth" },
  { title: "HubSpot integration", description: "Sync link clicks and conversions to HubSpot contacts. See utm.one data in your CRM timeline.", href: "/help/articles/hubspot-integration", icon: Users, tier: "growth" },
  { title: "Salesforce integration", description: "Push attribution data to Salesforce leads and opportunities. Prove marketing's revenue impact.", href: "/help/articles/salesforce-integration", icon: Users, tier: "business" },
  { title: "Zapier connection", description: "Connect utm.one to 5,000+ apps. Trigger workflows when links are created or clicked.", href: "/help/articles/zapier-integration", icon: Zap },
  { title: "Slack notifications", description: "Get alerts in Slack when campaigns launch, traffic spikes, or links hit milestones.", href: "/help/articles/slack-integration", icon: MessageSquare },
];
