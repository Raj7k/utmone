...
const articles = [
  ...
  },
  {
    ...
    href: "/help/getting-started#first-link",
    icon: Link2,
  },
  {
    ...
    href: "/help/getting-started#pixel",
    icon: Activity,
  },
  {
