      ...
      <div className="space-y-8">
        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="font-medium text-foreground">instant preview:</span> we show you a quick preview first so you're never waiting.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
              <div>
                <span className="font-medium text-foreground">precision update:</span> exact numbers fill in automatically in the background.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <TrendingUp className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
              <div>
                <span className="font-medium text-foreground">always accurate:</span> what you see is always reliable—no guessing.
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-display font-semibold">see it in action</h2>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              <CardDescription>data shown</CardDescription>
              <CardTitle className="text-3xl font-display">100%</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-3xl font-display">exact</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
