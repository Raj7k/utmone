...
import { MapPin, Calendar, Waves, TrendingUp, MoreVertical, QrCode, Download } from "lucide-react";
...
import { BoothQRDialog } from "./BoothQRDialog";
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 my-4">
            ...
            <div 
              className="flex flex-col items-center justify-center p-3 rounded-lg bg-muted/30 cursor-pointer group/qr hover:bg-muted/50 transition-colors relative"
            ...
            >
              <div className="bg-white p-2 rounded-md relative">
                ...
                />
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover/qr:opacity-100 transition-opacity flex items-center justify-center rounded-md">
