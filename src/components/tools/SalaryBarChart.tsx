    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          ...
          <div className="h-8 bg-muted/30 rounded-lg overflow-hidden">
            <div
              className="h-full transition-all duration-500 bg-purple-500/60"
          ...
          <div className="pt-4 border-t border-border/50">
            <div className="space-y-1">
              ...
              <div className="h-10 bg-muted/30 rounded-lg overflow-hidden border-2 border-primary">
                <div
                  className="h-full transition-all duration-500 flex items-center justify-end pr-2 bg-primary"
