            ...
            <div key={index} className="flex items-center gap-4 md:gap-8">
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center"
                >
                ...
                >
                  <div className="relative w-12 md:w-20 h-[2px]">
                    ...
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1">
                      <div className="w-0 h-0 border-l-[6px] border-l-primary/40 border-t-[4px] border-t-transparent border-b-[4px] border-b-transparent" />
                    </div>
                  </div>
                </motion.div>
              )}
