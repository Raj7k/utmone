...
export const StaticFeatureControlDeck = ({ tabs, badge }: FeatureControlDeckProps) => {
        ...
        <div className="relative min-h-[520px] md:h-[520px] rounded-[24px] md:rounded-[32px] overflow-hidden bg-card/20 border border-border shadow-2xl">
          ...
          <div className="flex flex-col md:hidden h-full">
            ...
            <div className="flex-1 p-5">
              <div
                key={activeIndex}
                className={`h-full flex flex-col transition-all duration-400 ease-out ${
          ...
          <div className="hidden md:flex h-full">
              ...
              <nav className="flex-1 flex flex-col gap-1">
                {tabs.map((tab, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Active pill with CSS transition instead of layoutId */}
                      <div
            ...
            <div className="flex-1 relative overflow-hidden">
              {/* Light Leak Effect with CSS */}
              <div
                className={`absolute inset-0 z-20 pointer-events-none bg-gradient-to-r from-transparent via-muted/10 to-transparent transition-all duration-500 ${
              ...
              <div
                key={activeIndex}
                className={`absolute inset-0 p-8 flex flex-col transition-all duration-500 ease-out ${
...
export { StaticFeatureControlDeck as FeatureControlDeck };
