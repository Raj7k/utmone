...
export const StaticFeatureBentoGrid = ({
  headline,
  subheadline,
  capabilities,
  items,
  ...
  return (
    <section className="py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div
          ref={headerRef}
          className="text-center mb-16 opacity-0 translate-y-8 data-[revealed]:opacity-100 data-[revealed]:translate-y-0 transition-all duration-700 ease-out"
          data-reveal
        >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.map((cap, index) => {
            ...
            return (
              <div
                key={cap.id || index}
                className="opacity-0 translate-y-8 scale-[0.98] animate-scale-up-fade"
...
export { StaticFeatureBentoGrid as FeatureBentoGrid };
