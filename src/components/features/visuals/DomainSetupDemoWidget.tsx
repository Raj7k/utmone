    ...
    <div className="w-full max-w-xl mx-auto">
      ...
      <div className="relative rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl overflow-hidden">
        ...
        <div className="p-6 min-h-[180px] flex items-center justify-center">
          <CSSAnimatePresence show={currentStep === 1} animation="fade">
          ...
          <CSSAnimatePresence show={currentStep === 2} animation="scale">
          ...
          <CSSAnimatePresence show={currentStep === 3} animation="scale">
            <div className="text-center space-y-4">
              <div 
                className="w-16 h-16 rounded-full bg-emerald-500/20 flex items-center justify-center mx-auto animate-scale-in"
