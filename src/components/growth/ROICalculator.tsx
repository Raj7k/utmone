        ...
        <Card className="p-8 space-y-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-label">Team Size</label>
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-primary" />
                <span className="text-lg font-bold text-primary">{teamSize}</span>
              </div>
            </div>
            <Slider
              value={[teamSize]}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-label">Hours/Week Cleaning Data</label>
              <div className="flex items-center gap-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-label">Average Salary</label>
              <div className="flex items-center gap-2">
          ...
          <Card className="p-8 bg-gradient-to-br from-primary/5 via-background to-primary/5 border-primary/20 h-full flex flex-col">
            <div className="flex-1 space-y-6">
              <div className="text-center">
                ...
                <h4 className="text-lg font-display font-semibold text-label mb-2 lowercase">
              ...
              <div className="text-center p-6 bg-destructive/10 rounded-xl border border-destructive/20">
                <div className="text-sm text-secondary-label mb-1">wasted annually on manual cleanup</div>
              ...
              <div className="text-center p-6 bg-primary/10 rounded-xl border border-primary/20">
                <div className="text-sm text-secondary-label mb-1">saved with utm.one</div>
              ...
              {/* ROI */}
              <div className="text-center">
                <div className="text-sm text-secondary-label mb-1">return on investment</div>
                <div className="text-5xl font-bold text-primary">{roi}%</div>
              </div>
            </div>
