                ...
                <div className="space-y-4 p-4 border border-border rounded-lg bg-muted/20">
                  ...
                  <div className="rounded-md border border-muted bg-muted/20 p-3 space-y-2">
                    ...
                    <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
                      ...
                      <li>Check propagation status at <a href="https://dnschecker.org" target="_blank" rel="noopener noreferrer" className="underline text-primary">dnschecker.org</a></li>
                                ...
                                <div key={idx} className="rounded-lg border border-border bg-card p-3 space-y-2">
                                  ...
                                  {item.link && (
                                    <a 
                                      ...
                                      className="text-xs hover:underline inline-flex items-center gap-1 text-primary"
                                    >
                                      open cloudflare →
                                    </a>
                                  )}
