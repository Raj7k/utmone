    ...
    <aside className="w-64 h-screen bg-card border-r border-border flex flex-col">
      ...
      <div className="h-14 flex items-center justify-between px-4 border-b border-border/50">
        ...
        <button
          ...
          className="w-7 h-7 rounded-md flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-colors hover:scale-105 active:scale-95"
        >
      ...
      <div className="px-3 py-3">
        <button
          onClick={openSearch}
          className="w-full h-9 px-3 rounded-lg border border-border/50 bg-muted/30 flex items-center gap-2 text-sm text-muted-foreground hover:border-border hover:bg-muted/50 transition-colors hover:scale-[1.01] active:scale-[0.99]"
        >
