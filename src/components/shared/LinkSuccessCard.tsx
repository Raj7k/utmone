...
export const LinkSuccessCard = ({
  ...
  return (
    <motion.div
      ...
      className={`p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-lg ${className}`}
    >
      {/* Success Icon & Title */}
      <div className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-green-900 dark:text-green-100 heading">
            {title}
          </h3>
      ...
      <div className="relative mb-4">
        <div className="p-4 bg-white dark:bg-card rounded-lg border border-border">
          <p className="text-sm font-mono text-label break-all">{url}</p>
        </div>
      </div>
