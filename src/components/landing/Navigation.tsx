                    ...
                    <ul className="grid w-[400px] gap-2 p-4">
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/bitly" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Bitly</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            trust, not just shortening
                          </p>
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/rebrandly" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Rebrandly</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            branding ≠ clarity
                          </p>
                        </Link>
                      ...
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/short-io" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Short.io</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                      ...
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/bl-ink" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Bl.ink</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            enterprise-clear, not heavy
                          </p>
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/rewardful" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Rewardful</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            attribution over payouts
                          </p>
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/partnerstack" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs PartnerStack</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            simple & predictable
                          </p>
                        </Link>
                      ...
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/firstpromoter" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs FirstPromoter</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            clarity first
                          </p>
                        </Link>
                      ...
                      <li>
                        <Link
                          ...
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
                            location.pathname === "/compare/tolt" && "bg-primary/10"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">utm.one vs Tolt</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            structured trust
                          </p>
                        </Link>
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                ...
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-semibold text-muted-foreground px-3 mb-2">Compare</p>
                    <Link to="/compare/bitly" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Bitly</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/rebrandly" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Rebrandly</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/short-io" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Short.io</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/bl-ink" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Bl.ink</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/rewardful" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Rewardful</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/partnerstack" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs PartnerStack</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/firstpromoter" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs FirstPromoter</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                    <Link to="/compare/tolt" onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-accent transition-colors">
                      <span>vs Tolt</span>
                      <ChevronRight className="h-4 w-4" />
                    </Link>
                  </div>
