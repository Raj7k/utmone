  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-primary/20 mb-6 shadow-sm">
            <Sparkles className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium text-primary lowercase">clean-track intelligence</span>
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground lowercase mb-6">
        ...
        >
          <Link to="/early-access">
            <Button size="lg" className="lowercase shadow-lg">
              get early access
