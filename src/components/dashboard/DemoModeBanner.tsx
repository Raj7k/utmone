// PHASE 23: Removed framer-motion/AnimatePresence - using pure CSS animations
...
export const DemoModeBanner = () => {
  ...
  if (isCollapsed) {
    return (
      <div className="flex items-center justify-between rounded-lg bg-white/5 border border-white/10 px-4 py-2 animate-fade-in">
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-white/10 via-white/5 to-transparent border border-white/20 p-4 animate-fade-in">
