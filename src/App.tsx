...
import { NotificationContext, NotificationProvider, noopNotificationContextValue } from "./contexts/NotificationContext";
...
import { ModalContext, ModalProvider, noopModalContextValue } from "./contexts/ModalContext";
...
const PostPaintProviders = ({ children }: { children: React.ReactNode }) => {
  const postPaintReady = usePostPaintReady();

  const preflightProviders = useMemo(
    () => (
      <NotificationContext.Provider value={noopNotificationContextValue}>
        <ModalContext.Provider value={noopModalContextValue}>
          {children}
